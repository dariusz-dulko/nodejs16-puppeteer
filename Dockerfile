...
RUN yum install -y centos-release-scl-rh && \
    ...
    yum install -y ffmpeg xfonts-75dpi xfonts-cyrillic xfonts-scalable xfonts-100dpi xfonts-base gtk2-engines-pixbuf xorg-x11-server-Xvfb GConf2 alsa-lib atk atkmm glibc cairo cups cups-libs dbus dbus-x11 expat fontconfig libgcc gdk-pixbuf2 glib2 gtk3 ipa-gothic-fonts nspr pango libstdc++ libSM libX11 libX11-common libX11-devel libXScrnSaver libxcb libXcomposite libXcursor libXdamage libXext libXfixes libXi libXrandr libXrender libXtst ca-certificates liberation-fonts libappindicator nss nss-devel redhat-lsb xdg-utils wget mesa-libgbm mesa-libgbm-devel xorg-x11-fonts-100dpi xorg-x11-fonts-75dpi xorg-x11-fonts-cyrillic xorg-x11-fonts-misc xorg-x11-fonts-Type1 xorg-x11-utils && \
    node --version
